...
export default function Header() {
  ...
  return (
    <header className="relative z-[999]">
      <motion.div
        className="background-blur-[0.5rem] fixed left-1/2 top-0 h-[4.5rem] w-full rounded-none border border-white border-opacity-40 bg-white bg-opacity-95 shadow-lg shadow-black/[0.03] sm:top-6 sm:h-14 sm:w-[36rem] sm:rounded-full"
